    ...
    <div className={styles.page}>
      <div className={styles.container}>
        <div className={styles.layoutLeft}>
            ...
            <a className={styles.settings} onClick={useLinkClickHandler("/settings")}>Настройки</a>
        </div>
        <div className={styles.layoutRight}>
            <a className={styles.username}>{userData ? userData.username : 'Лунтик'}</a>
            <a className={styles.ratingHeader}>Рейтинг: #123234</a>
            <a className={styles.readyTasksHeader}> Решенные задачи </a>
            
            <svg className={styles.lineSvg} width="" height="2" viewBox="0 0 879 2" fill="none" xmlns="http://www.w3.org/2000/svg">
