...
export function TheorySidebar({handleClickTheory, description, title}:Props) {
    
    return (
    <div className={styles.container}>
        <div className={styles.theoryLayout}>
            <div className={styles.theoryBar}>
                <svg className={styles.closeSvg} onClick={handleClickTheory}  width="50" height="50" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
