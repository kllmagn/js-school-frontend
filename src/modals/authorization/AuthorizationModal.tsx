...
export function AuthorizationModal({ onChange }: Props) {
	...
	return (
		<div>
			<div className={styles.registrationModal}>
				...
				<a className={styles.textRegistration}>Вход</a>
				...
				<div className={styles.containerForm}>
					<form className={styles.formsModal} onSubmit={handleSubmit}>
						<textarea value={usernameValue} onChange={handleUsernameChange}>
							Эл. почта
						</textarea>
						<textarea value={passwordValue} onChange={handlePasswordChange}>
							Пароль
						</textarea>
						<button className={styles.buttonRegist}>Войти</button>
					</form>
					<div className={styles.gavnoContainer}>
						<a>Регистрация</a>
						<a className={styles.gavno}>Забыли пароль?</a>
					</div>
				</div>
			</div>
