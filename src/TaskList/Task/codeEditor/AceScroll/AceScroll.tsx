...
export function AceScroll() {
  ...
  `,
	...
	return (
		<div
			className={styles.aceScroller}
			style={{ lineHeight: "21px", left: "52px", right: "15px", bottom: "0px" }}
		>
			<div
				className={styles.aceContent}
				style={{
			...
			>
				...
				<div
					className={`${styles.aceLayer} ${styles.aceTextLayer}`}
					style={{
						height: "1e+06px",
						margin: "0px 4px",
